...
| `platform/product-ui/worker` | Private room coordination, membership and client reports | Cloudflare Durable Objects and shared room protocol; no gameplay engine imports |
